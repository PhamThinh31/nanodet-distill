...
model_path = os.path.join(ROOTPATH,cfg.save_dir,'model_best/model_best.ckpt')
save_path = os.path.join(ROOTPATH,'results',cfg.save_dir)

if not os.path.exists(save_path):
    os.makedirs(save_path)

valDataFolder = cfg.data.val.img_path
valDataPath = cfg.data.val.ann_path
