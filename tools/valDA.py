...
def main(args):
    ...
    task = TrainingTaskDA(cfg, evaluator)
    ...
    trainer.validate(task,val_dataloader,'/home/ubuntu/Workspace/thinhplg-dev/domain_adaptation/od/nanodet_v2/workspace/a2d2-inhouse-3class-origin-withDA/model_best/model_best.ckpt')
