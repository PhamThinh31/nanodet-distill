...
from ..transform import PipelineDA


class BaseDatasetDA(Dataset, metaclass=ABCMeta):
    """
    ...
    def __init__(
        ...
        self.img_target_path = img_target_path
        self.ann_target_path = ann_target_path
        self.image_size = image_size
        self.resizecrop = resizecrop
        self.input_size = input_size
        self.pipeline = PipelineDA(pipeline, keep_ratio)
        ...
        self.data_info, self.data_target_info = self.get_data_info(ann_path,ann_target_path
        )
